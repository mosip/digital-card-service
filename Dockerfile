...
ENTRYPOINT ["/bin/bash", "-c", " \
    wget '${artifactory_url_env}/artifactory/libs-release-local/pdf-generator/pdf-generator.zip' && \
    ...
    sudo chown -R root:root '${loader_path_env}/pdf-generator' && \
    sudo chown root:root '${loader_path_env}/kernel-auth-adapter.jar' && \
